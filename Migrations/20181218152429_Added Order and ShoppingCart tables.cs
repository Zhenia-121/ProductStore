...
{
    public partial class AddedOrderandShoppingCarttables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Contact_HomeNumber = table.Column<int>(nullable: false),
                    Contact_Street = table.Column<string>(nullable: true),
                    Contact_City = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingCartsProducts", x => new { x.ProductId, x.ShoppingCartId });
                    table.ForeignKey(
